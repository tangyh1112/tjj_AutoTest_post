...
class eventRecord(unittest.TestCase):
    ...
    def test_04_metaevent(self):
        ...
        if self.eventName == "":
            for key in keyList:
                ...
                Properties = {
                              "code": "sx_"+key+"Codetest"+ str(num),
                              "name": "sx_"+key+"Nametest"+ str(num),
    ...
    def test_0701_delmetaevent(self):
        ...
        一：元事件在当天创建的，可以删除
        '''
        url_part = "/dmp/metaevent/" + str(event['id'])
    ...
    def test_0702_delmetaevent(self):
        ...
        '''
        url_part = "/dmp/metaevent/" + str(self.usedEventId)
    ...
    def test_0801_delmetaeventType(self):
        ...
        一：分类下不存在元事件，删除成功
        '''
        url_part = "/dmp/metaeventtype/" + str(event['typeId'])
    ...
    def test_0802_delmetaeventType(self):
        ...
        '''
        typeId = 18
        url_part = "/dmp/metaeventtype/" + str(self.usedTypeId)
    ...
    def getSqlResult(self):
        ...
        if eventResult:
            ...
            eventnum = 0
        eventCode = "eventCodetest" + str(int(eventnum) + 1)
        eventName = "eventNametest" + str(int(eventnum) + 1)
        if eventpropertyResult:
            ...
            propertynum = 0
        sxNum =  int(propertynum)
        sqlResult = [eventCode, eventName, sxNum]
        return sqlResult
